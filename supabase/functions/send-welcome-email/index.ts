...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const emailHtml = `
      <!DOCTYPE html>
      <html>
        <head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Welcome to Marketplace Nepal!</title></head>
            ...
            <tr><td align="center">
              <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                ...
                <tr><td style="padding: 40px 30px;">
                  <p style="color: #374151; font-size: 18px; line-height: 1.6; margin: 0 0 20px 0;">Hi <strong>${userName}</strong>! 👋</p>
                  <p style="color: #374151; font-size: 16px; line-height: 1.6; margin: 0 0 24px 0;">Thank you for joining Marketplace Nepal! We're thrilled to have you as part of our community.</p>
                  ...
                  <div style="background: linear-gradient(135deg, #fef3c7 0%, #fde68a 100%); border-radius: 12px; padding: 24px; text-align: center; margin: 30px 0;">
                    ...
                    <p style="color: #a16207; margin: 0; font-size: 16px;">You've earned <strong>100 loyalty points</strong> just for signing up!</p>
                  </div>
                </td></tr>
                <tr><td style="background-color: #f9fafb; padding: 30px; text-align: center; border-top: 1px solid #e5e7eb;">
                  <p style="color: #6b7280; font-size: 14px; margin: 0 0 8px 0;">Need help? Reply to this email or visit our support page.</p>
                  <p style="color: #9ca3af; font-size: 12px; margin: 0;">© 2024-2026 Marketplace Nepal Pvt. Ltd.<br>New Road, Kathmandu, Nepal</p>
                </td></tr>
              </table>
            </td></tr>
          </table>
