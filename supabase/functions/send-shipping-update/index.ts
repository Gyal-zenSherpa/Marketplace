...
const statusConfig = {
  processing: { emoji: "📦", title: "Order Processing", message: "We're preparing your order for shipment.", color: "#f59e0b", bgColor: "#fffbeb" },
  shipped: { emoji: "🚚", title: "Order Shipped!", message: "Your order is on its way to you.", color: "#3b82f6", bgColor: "#eff6ff" },
  out_for_delivery: { emoji: "🏃", title: "Out for Delivery", message: "Your order will arrive today!", color: "#8b5cf6", bgColor: "#f5f3ff" },
  delivered: { emoji: "✅", title: "Order Delivered!", message: "Your order has been delivered successfully.", color: "#10b981", bgColor: "#ecfdf5" },
};
        ...
        <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
          ...
          <div style="padding: 30px;">
            ...
            <div style="margin: 30px 0;">
              ...
              <div style="display: flex; align-items: flex-start; justify-content: space-between;">${progressHtml}</div>
            </div>
          ...
          <div style="background-color: #1f2937; padding: 25px; text-align: center;">
            ...
            <p style="margin: 0;"><a href="mailto:marketplaceauthentic01@gmail.com" style="color: #fbbf24; text-decoration: none;">marketplaceauthentic01@gmail.com</a><span style="color: #6b7280;"> | </span><a href="tel:9763689295" style="color: #fbbf24; text-decoration: none;">9763689295</a></p>
